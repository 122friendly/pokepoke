...
<!-- 									<input type="checkbox" class="all_check_input input_size_20" checked="checked"><span class="all_chcek_span">전체선택</span> -->
										...
										<input type="hidden" class="hdn_cartId_input" data-cartId="${cart.cartId}">
                                    ...
                                    <td class="product__cart__item">
                                        ...
                                        <div class="product__cart__item__pic" style="margin-top: 20px;">
                                       		<input type="checkbox" class="cart_checkbox input_size_20" style="margin-right: 10px;">                                    	
...
<!--                             <input type="text" placeholder="추후 업데이트 예정입니다. ๑◕‿‿◕๑" id="couponCode">
                    ...
                    <div class="cart__total aside-inner" id="cartTotal">
                        ...
                        <a href="/payment/payment" class="primary-btn" onclick="return checkStoreNames()">결 제 하 기</a>                   		
                    </div>
                    </div>
                </div>
            </div>
...
function TotalCartInfo() {
	...
	$(".cartInfo_tr").each(function(index, element) {
	   ...
	   function checkStoreNames() {
	        ...
	        return true; // 모든 체크박스가 유효한 경우 submit 이벤트 실행
	      }
</script>
