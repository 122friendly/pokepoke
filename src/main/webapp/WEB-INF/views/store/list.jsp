							...
							<tbody class="table-group-divider">
								<c:forEach items="${list}" var="store">
									<tr>
										...
										<td><form action = "/product/list" method="post" name="storeNamemenu">
										<input type="submit"
												style="background-color: #469543; color: #fff; border-radius: 30px; padding: 5px 7px; border: none; margin: 0 auto; font-size: 12px;" value="주문">
										...
										<td><input type="button"
												...
												style="background-color: #469543; color: #fff; border-radius: 30px; padding: 5px 7px; border: none; margin: 0 auto; font-size: 12px;" value="수정"></td>
										<td><form
														action="${pageContext.request.contextPath}/store/deleteProcess"
														method="get">
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="product__pagination">
								<form id='actionForm' action="/store/list#storeList2" method='get'>
									<input type='hidden' name='pageNum'
										value='${pageMarker.page.pageNum }'> <input
...
async function getLocation() {
	...
	$(document).ready(async function() {
		  ...
		  function createMarkerAndInfoWindow(map, list, params) {
		    ...
		    let contentString = [
		        '   <span class="close" style="position: absolute; top: 10px; right: 15px;">&times;</span>',
